    ...
    div []
        ...
        , div [ class "main-container" ]
            ...
            , regFormField model model.userError.name
                ...
                , "text"
                , "name"
                , "^[A-Za-záàâãéèêíïóôõöúçñÁÀÂÃÉÈÊÍÏÓÔÕÖÚÇÑ ]{1,50}$"
                , "Por favor insira um nome entre 1 e 50 caracteres"
                )
            ...
            , regFormField model model.userError.alias_
                ...
                , "alias_"
                , "^[A-Za-z0-9_.]{1,20}$"
                , "Por favor insira um usuário de 1 a 20 caracteres alfanuméricos. Somente _ e . são permitidos."
                )
            , div [ class "item-form" ]
                [ input
                    [ placeholder "E-mail"
